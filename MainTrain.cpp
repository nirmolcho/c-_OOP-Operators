...
int main()
{
    ...
    if( shapes.totalArea() != 65 )
        cout << "Error with totalArea = 65 (-3) you got :" << shapes.totalArea() << endl;

    if( shapes.totalPerimeter() != 64 )
        cout << "Error with totalPerimeter = 64 (-3) you got :" << shapes.totalPerimeter() << endl;
//0x600002f04930
    if( shapes.totalCircleArea() != 40 )
        cout << "Error with totalCircleArea = 40 (-3) you got :" << shapes.totalCircleArea() << endl;

    if( shapes.totalSquarePerimeter() != 12 )
        cout << "Error with totalSquarePerimeter = 12 (-3) you got :" << shapes.totalSquarePerimeter() << endl;
    ...
    if( shapes.totalArea() != 32 )
        cout << "Error with totalArea = 32 (-3) you got :" << shapes.totalArea() << endl;

    if( shapes.totalPerimeter() != 34 )
        cout << "Error with totalPerimeter = 34 (-3) you got :" << shapes.totalPerimeter() << endl;

    if( shapes.totalCircleArea() != 12 )
        cout << "Error with totalCircleArea = 19 (-3) you got :" << shapes.totalCircleArea() << endl;

    if( shapes.totalSquarePerimeter() != 8 )
        cout << "Error with totalSquarePerimeter = 8 (-3) you got :" << shapes.totalSquarePerimeter() << endl;
